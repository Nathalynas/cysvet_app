...
class _ReportPdfActionsState extends ConsumerState<_ReportPdfActions> {
  ...
  Widget build(BuildContext context) {
    ...
    final unavailableMessage = canUsePdf
        ? null
        : 'PDF disponível após sincronizar a visita.';
    ...
    return Align(
      ...
      child: Row(
        ...
        children: [
          Tooltip(
            message: unavailableMessage ?? 'Compartilhar relatório em PDF',
            child: AppButton(
              text: 'Compartilhar',
              outlined: true,
              height: 40,
          ...
          Tooltip(
            message: unavailableMessage ?? 'Exportar relatório em PDF',
            child: AppButton(
              text: 'Exportar PDF',
              height: 40,
              borderRadius: 10,
    ...
    try {
      ...
      if (action == _ReportPdfAction.share) {
        await Printing.sharePdf(
          ...
          body: 'Relatório técnico da visita em ${widget.propertyName}.',
        );
      } else {
